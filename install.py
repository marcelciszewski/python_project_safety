...
if ask == "yes" or ask == "Yes":
	...
	if option == "1":
		print("Downloading...")
		URL = "https://github.com/realinteldiscord2004/esafetypython/raw/main/Python_Project.zip"
		response = wget.download(URL, "Python_Project.zip")
		print(" ")
		print("==============================================")
		print("Finished!")
		...
		print("Downloading...")
		URL = "https://raw.githubusercontent.com/realinteldiscord2004/python_project_safety/main/project/project.py"
